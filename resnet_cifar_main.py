...
flags.DEFINE_string('train_data_path', '/home/hdd0/dataset/cifar10_data',
...
def evaluate(hps):
    ...
    while True:
        ...
        best_precision_summ.value.add(
            tag='Best_Precision', simple_value=best_precision)
        summary_writer.add_summary(best_precision_summ, train_step)
        summary_writer.add_summary(summaries, train_step)
        tf.logging.info('loss: %.3f, Validation_precision: %.3f, Validation_best_precision: %.3f' %
