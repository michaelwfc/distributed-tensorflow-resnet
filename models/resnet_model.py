...
class ResNet(object):
    ...
    def _build_train_op(self):
        ...
        if FLAGS.job_name != None and FLAGS.sync_replicas:
            ...
            print("Start the SyncReplicasOptimizer:the ,the job_name:{0},the replicas_to_aggregate:{1}".format(
                FLAGS.job_name, replicas_to_aggregate))
        ...
        if FLAGS.job_name != None and FLAGS.sync_replicas:
            print("start dist sync init,the job_name:{0},the sync_replicas:{1}".format(FLAGS.job_name,
                                                                                       FLAGS.sync_replicas))
